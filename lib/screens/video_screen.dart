    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        if (_ready && _chewieCtrl != null)
          ...
          AspectRatio(
            aspectRatio: 16 / 9,
            child: Container(color: const Color(0xFF111),
        ...
        Expanded(
          child: ListView(padding: const EdgeInsets.all(12), children: [
            ...
            // Action buttons
            Row(children: [
              _actionBtn(icon: _liked ? Icons.thumb_up : Icons.thumb_up_outlined,
                  label: _formatCount(_likeCount), active: _liked, onTap: _onLike),
              const SizedBox(width: 16),
              _actionBtn(icon: _disliked ? Icons.thumb_down : Icons.thumb_down_outlined,
                  label: '', active: _disliked, onTap: _onDislike),
              const SizedBox(width: 16),
              _actionBtn(icon: Icons.reply, label: 'Поделиться', onTap: () =>
            ...
            Container(
              ...
              child: Row(children: [
                CircleAvatar(
                  radius: 20, backgroundColor: const Color(0xFF333),
                  ...
                  child: (widget.video.avatar == null || widget.video.avatar!.isEmpty)
                      ? Text(widget.video.username[0].toUpperCase(), style: const TextStyle(color: Colors.white))
                      : null,
                ),
                ...
                FilledButton(
                  ...
                  child: Text(_subscribed ? 'Подписан' : 'Подписаться', style: const TextStyle(fontSize: 13)),
                ),
              ]),
            ),
            const SizedBox(height: 16),
            ...
            if (widget.video.description.isNotEmpty)
              Container(
                padding: const EdgeInsets.all(12),
                decoration: BoxDecoration(color: const Color(0xFF1A1A1A), borderRadius: BorderRadius.circular(12)),
                child: Text(widget.video.description, style: const TextStyle(color: Colors.white70, fontSize: 13)),
              ),
            ...
            Row(children: [
              ...
              const SizedBox(width: 8),
              IconButton(icon: const Icon(Icons.send, color: Color(0xFF6C5CE7)), onPressed: _sendComment),
            ]),
            const SizedBox(height: 16),
